function Card(title, expierence, image, text, live, source) {
  this.title = title;
...
const live = 'https://gintsm.github.io/Portfolio-mobile-version/';
const source = 'https://github.com/GintsM/Portfolio-mobile-version';
const firstTasktxt = 'This project was built a simple list of To Do tasks. The functionality - Add task, remove individual task, edit already created task, clear all completed tasks. Web page was built using webpack and served by a webpack dev server. To create best UI I used class with static methods, eventlistener using propogation to give smoother work';
const firstLive = 'https://gintsm.github.io/To_do_list/dist/';
const firstSource = 'https://github.com/GintsM/To_do_list';

const card1 = new Card('ToDo List', ['Microverse', 'Front End Dev', '2021'], 'images/todo.png', firstTasktxt, firstLive, firstSource);
const card2 = new Card('MULTI-POST STORIES', ['FACEBOOK', 'Fullstack Dev', '2021'], 'images/Snap2.png', text, live, source);
const card3 = new Card('Facebook 360', ['FACEBOOK', 'Fullstack Dev', '2021'], 'images/Snap3.png', text, live, source);
const card4 = new Card('UBER NAVIGATION', ['UBER', 'Lead Developer', '2021'], 'images/Snap4.png', text, live, source);
...
seeLive.forEach((live) => live.addEventListener('click', () => { window.location = card1.toGo.live; }));
const seeSource = document.querySelectorAll('div:nth-child(2) > button:nth-child(2)');
seeSource.forEach((source) => source.addEventListener('click', () => { window.location = card1.toGo.source; }));